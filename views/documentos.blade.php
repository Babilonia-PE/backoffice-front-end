				...
				<div class="row align-items-end">
              		<div class="col-md-4">
                		<div class="form-group">
                  			...
                  			<input type="text" class="form-control form-control-sm" id="id" placeholder="Número de documento">
                		</div>
                	</div>
              		<div class="col-md-4">
                		<div class="form-group">
                  			<label>Tipo de documento</label>
							@component("components.select", ['data'=>APP_DOCUMENT_TYPE, 'id' => "document_type", 'placeholder' => 'Tipo de documento', 'first' => true])
							@endcomponent  
                		</div>
                	</div>
					<div class="col-md-4">
...
<script type="module">
	...
	const headers = [
		...
		{ "title": "Tipo de documento", "code": "document_type_id" },
		{ "title": "Documento", "code": "id" },
		{ "title": "Acciones" }
	];
	const filtersFields = [
		{
